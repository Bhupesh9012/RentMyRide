  ...
  return (
    ...
    //</div>
     <section className="bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <img src="../src/assets/contact-us-communication-support-service-assistance-concept.jpg" className='h-full w-full'/>
      <h1 className='flex justify-center text-3xl font-bold text-gray-800'>Let's Start a Conversation</h1>
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 bg-white shadow-xl rounded-2xl p-8">
        ...
        {/* Right side: Optional contact info */}
        <div className="bg-blue-50 p-6 rounded-lg shadow-inner">
          ...
          <p className="text-gray-700"><strong>Location:</strong> Pithoragarh, India</p>
        </div>
      </div>
      ...
      <footer className="bg-gray-900 text-white py-10 mt-10">
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p>Your premium car rental service. Unleash your beast with every ride.</p>
          </div>
          <div>
